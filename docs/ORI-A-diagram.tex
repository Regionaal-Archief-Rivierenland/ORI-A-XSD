   ...
   \node (nevenfunctie) [ORI object, above left = 2.2cm and -9cm of natuurlijkpersoon, align=center, draw=gray!86]
        {
          ...
          \attrib{Indicator bezoldigd}{boolean}{[0..1]} \\
   ...
   \node (fractielidmaatschap) [ORI relatieklasse, below = 4.0cm of deelnemer, align=center]
        {
          ...
          \attrib{Indicate voorzitter}{boolean}{[0..1]}
        };
   ...
   \node (mediabron) [ORI object, align=center, above=3.2cm of vergadering]
        {
          ...
          \attrib{Mediabron type}{\enumeratietype{mediabronType}}{[0..1]} \\
          \attrib{URL}{URI}{[0..1]}
        };
  ...
  \node (mdto-inner) [rectangle, draw=mainblack, text=mainblack, ultra thick, right = 3.2cm of vergaderstuk, inner sep=40pt, fill=githubgrey, align=center]
        {
          ...
          \centering
          {\LARGE \fontseries{sb}\selectfont Informatieobject} \\[0.5ex]
          {\Large MDTO/TMLO}
        \end{minipage}
        };
